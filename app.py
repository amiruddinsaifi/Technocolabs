...
with open(r"model/toxic_vect.pkl", "rb") as f:
    tox = pickle.load(f)

with open(r"model/severe_toxic_vect.pkl", "rb") as f:
    sev = pickle.load(f)

with open(r"model/obscene_vect.pkl", "rb") as f:
    obs = pickle.load(f)

with open(r"model/insult_vect.pkl", "rb") as f:
    ins = pickle.load(f)

with open(r"model/threat_vect.pkl", "rb") as f:
    thr = pickle.load(f)

with open(r"model/identity_hate_vect.pkl", "rb") as f:
    ide = pickle.load(f)

# Load the pickled RDF models
with open(r"model/toxic_model.pkl", "rb") as f:
    tox_model = pickle.load(f)

with open(r"model/severe_toxic_model.pkl", "rb") as f:
    sev_model = pickle.load(f)

with open(r"model/obscene_model.pkl", "rb") as f:
    obs_model  = pickle.load(f)

with open(r"model/insult_model.pkl", "rb") as f:
    ins_model  = pickle.load(f)

with open(r"model/threat_model.pkl", "rb") as f:
    thr_model  = pickle.load(f)

with open(r"model/identity_hate_model.pkl", "rb") as f:
